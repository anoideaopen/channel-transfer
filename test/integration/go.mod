...
require (
	...
	github.com/anoideaopen/foundation v0.1.6-0.20260115154453-4bcad48f21a6
	github.com/anoideaopen/foundation/test/integration v0.0.0-20260115154453-4bcad48f21a6
